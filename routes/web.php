...
use App\Http\Controllers\Web\Vendor\Product\VendorProductReviewController;
...
//     ->name('xpay.rollback');
    ...
    // REVIEWS (vendor/reviews/…)
            ...
            //     Route::post('/{id}/toggle-visibility', [VendorProductReviewController::class, 'toggleVisibility'])->name('toggle-visibility');
            // });
