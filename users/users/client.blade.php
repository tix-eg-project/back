            ...
            <div class="card w-100" style="max-width: 1000px;">
                ...
                <div class="d-flex justify-content-between align-items-center p-3">
                    ...
                    <form method="GET" action="{{ route('admin.pages.client.index') }}" id="searchForm" class="d-flex"
                        style="gap: 10px;">
                        <input type="text" name="search" id="ClientSearch" class="form-control text-dark text-center"
                            placeholder="{{ __('dashboard.Search by client name') }}" value="{{ request('search') }}"
                            style="width: 250px;">
                    </form>
                </div>
